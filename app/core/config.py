...
class Settings(BaseSettings):
    ...
    TELEGRAM_ACCOUNT_INITIAL_SYNC_DIALOG_LIMIT: int = 500
    TELEGRAM_ACCOUNT_INITIAL_SYNC_MESSAGES_PER_DIALOG: int = 30
    TELEGRAM_ACCOUNT_INITIAL_SYNC_MEDIA_MAX_MB: int = 50
    TELEGRAM_ACCOUNT_INITIAL_SYNC_TOTAL_MEDIA_MAX_MB: int = 512
    ...
    FUNNEL_SCHEDULED_DELIVERY_RETRY_BASE_SECONDS: int = 5
    ...
    CHANNEL_ATTRIBUTION_INVITE_TTL_SECONDS: int = 86400
    CHANNEL_ATTRIBUTION_CLEANUP_INTERVAL_SECONDS: int = 3600
    CHANNEL_ATTRIBUTION_BROWSER_TIMEOUT_MS: int = 5000
