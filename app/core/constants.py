...
class RoleName:
    ...
    ALL: frozenset[str] = frozenset({SUPER_ADMIN, ADMIN, MANAGER, BUYER, OPERATOR})
    STAFF: frozenset[str] = frozenset({ADMIN, MANAGER, BUYER, OPERATOR})
    ADMIN_MANAGED: frozenset[str] = frozenset({MANAGER, BUYER, OPERATOR})
