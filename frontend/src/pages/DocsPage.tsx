      ...
      <div className="mx-auto w-full max-w-7xl space-y-5 pb-8">
        ...
        <Section id="domains" title="Лендинги, домены и техдомен" kicker="Трафик и DNS" icon={Globe2}>
          ...
          <InfoCallout title="Кампания, UTM и пиксели" tone="cyan">
            У лендинга можно задать Meta Pixel, TikTok Pixel и Google Tag. Каждый получает PageView
            при открытии и событие TelegramOpen при переходе. UTM из рекламной ссылки сохраняются в
            карточке лида, а значения UTM defaults подставляются, если в URL их нет. Для входа не со
            старта выберите шаг активной опубликованной воронки: ссылка хранит ключ шага, поэтому
