        ...
        <Section id="funnels" title="Воронки" kicker="Конструктор сценариев" icon={Workflow}>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-400">
                Для каждого сообщения в цепочке отдельно включается индикатор активности и задаётся его
                длительность. Telegram показывает «печатает» для текста, запись голосового или кружка для
                соответствующего типа медиа и подготовку вложения для остальных файлов.
              </p>
              <p className="mt-2 text-sm leading-6 text-gray-400">
