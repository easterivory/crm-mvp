        ...
        <Section id="domains" title="Лендинги, домены и техдомен" kicker="Трафик и DNS" icon={Globe2}>
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-400">
                В рекламе используется ваш домен или поддомен. CRM хранит домен, slug лендинга и
                tracking_link_id. Пользователь открывает рекламный домен, а сервер CRM отдает лендинг
                или редирект в Telegram с ref/UTM. Техдомен нужен как DNS-цель, но пользователю обычно
                показывается именно рекламный домен.
              </p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
